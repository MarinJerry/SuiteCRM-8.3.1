...
',
  ...
  'LBL_POPHELP_IMPORTABLE' => '<b>Sí</b>: El campo se incluirá en una operación de importación.<br><b>No</b>: El campo no se incluirá al importar.<br><b>Requerido</b>: Debe proporcionarse un valor para el campo en cualquier importación.',
  'LBL_POPHELP_IMAGE_WIDTH' => 'Introduzca un número para el Ancho, medido en píxeles.<br> La imagen cargada se escalará a ese ancho.',
  'LBL_POPHELP_IMAGE_HEIGHT' => 'Introduzca un número para la Altura medida en píxeles.<br> La imagen cargada será escalada a esta Altura.',
  'LBL_POPHELP_DUPLICATE_MERGE' => '<b>Activado</b>: El campo aparecerá en la función Unir Duplicados, pero no estará disponible para usarla como condición de filtro en la función Encontrar Duplicados.<br><b>Desactivado</b>: El campo no aparecerá en la función Unir Duplicados y no estará disponible en Encontrar Duplicados.<br><b>Filtro</b>: El campo aparecerá en las funciones Unir Duplicados y Encontrar Duplicados.<br><b>Filtro seleccionado por defecto</b>: El campo aparecerá en la función Unir Duplicados y se utilizará por defecto en Encontrar duplicados.<br><b>Sólo filtro</b>: El campo no aparecerá en la función de Unir Duplicados, pero estará disponible en Encontrar Duplicados.',
  ...
  array (
    ...
    'phone' => 'Teléfono',
    'currency' => 'Moneda',
    'html' => 'HTML de Sólo Lectura (obsoleto, usar TextBlock)',
