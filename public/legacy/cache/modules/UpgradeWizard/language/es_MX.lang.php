...
$mod_strings = array (
  ...
  'ERR_UW_UPLOAD_ERR' => 'Ha ocurrido un error en la subida del archivo, por favor, inténtelo de nuevo<br>
',
  ...
  'LBL_UW_COMMIT_ADD_TASK_DESC_1' => 'Copias de seguridad de archivos sobrescritos están en el siguiente directorio: 
',
...
',
  ...
  'LBL_UW_START_DESC2' => 'Nota: Le recomendamos que cree una copia de la instancia de SuiteCRM que se utiliza en producción y pruebe el paquete de actualización antes de implementar la nueva versión. Si ha cambiado el archivo "composer.json", ejecute después de finalizado el proceso de actualización:<br/><br/><pre>composer install --no-dev</pre>',
  ...
  'LBL_RECOMMENDED_PHP_VERSION_2' => ' o superior',
  ...
  'LBL_PATCHUPGRADES' => 'Parche de actualizaciones',
  'LBL_THEMES' => 'Temas',
