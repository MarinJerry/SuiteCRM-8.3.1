<?php /* Smarty version 2.6.33, created on 2024-09-09 21:25:21
         compiled from themes/suite8/include/DetailView/tab_panel_content.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'themes/suite8/include/DetailView/tab_panel_content.tpl', 52, false),array('function', 'sugar_evalcolumn', 'themes/suite8/include/DetailView/tab_panel_content.tpl', 146, false),array('function', 'sugar_field', 'themes/suite8/include/DetailView/tab_panel_content.tpl', 152, false),)), $this); ?>
{*
/**
 *
...
?>
        ...
        <?php if ($this->_foreach['colIteration']['total'] > 1 && $this->_tpl_vars['colData']['colspan'] != 3): ?>
            ...
            <div class="col-xs-12 col-sm-6 detail-view-row-item detail-view-bordered" data-field="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
">
        <?php else: ?>
            {*<!-- DIV column - colspan = 3 -->*}
            <div class="col-xs-12 col-sm-12 detail-view-row-item" data-field="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
">
        <?php endif; ?>
...
'<?php endif; ?>>
                    <?php else: ?>
                        {*<!-- phone (version 2) -->*}
                        <div class="col-xs-12 col-sm-10 detail-view-field d-flex<?php if ($this->_tpl_vars['inline_edit'] && ! empty ( $this->_tpl_vars['colData']['field']['name'] ) && ( $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['inline_edit'] == 1 || ! isset ( $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['inline_edit'] ) )): ?> inlineEdit<?php endif; ?><?php if (isset ( $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['type'] ) && $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['type'] == 'phone'): ?> phone<?php endif; ?>" type="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['type']; ?>
" field="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
" <?php if ($this->_tpl_vars['colData']['colspan']): ?>colspan='<?php echo $this->_tpl_vars['colData']['colspan']; ?>
'<?php endif; ?>>
                    <?php endif; ?>
