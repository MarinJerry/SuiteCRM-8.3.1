<?php /* Smarty version 2.6.33, created on 2024-09-13 19:49:18
...
<div style="display:none;">
	...
	<div id="reminder_template">
		...
		<div class="col">
			<label><?php if (! empty ( $this->_tpl_vars['MOD']['LBL_REMINDERS_ACTIONS'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_REMINDERS_ACTIONS']; ?>
<?php endif; ?></label>&nbsp;
        </div>
	...
	<div id="reminder_template">
		...
		<div class="col">
			<span><?php if (! empty ( $this->_tpl_vars['MOD']['LBL_REMINDERS_ACTIONS'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_REMINDERS_ACTIONS']; ?>
<?php endif; ?></span>&nbsp;
        </div>
        ...
        <div class="col">
			<input type="checkbox" class="popup_chkbox" disabled="disabled"><span><?php if (! empty ( $this->_tpl_vars['MOD']['LBL_REMINDERS_POPUP'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_REMINDERS_POPUP']; ?>
<?php endif; ?></span>&nbsp;
			<!-- <span><?php if (! empty ( $this->_tpl_vars['MOD']['LBL_REMINDERS_WHEN'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_REMINDERS_WHEN']; ?>
<?php endif; ?></span> -->
		...
		<div class="col">
			<input type="checkbox" class="email_chkbox" disabled="disabled"><span><?php if (! empty ( $this->_tpl_vars['MOD']['LBL_REMINDERS_EMAIL'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_REMINDERS_EMAIL']; ?>
<?php endif; ?></span>&nbsp;
			<!-- <span><?php if (! empty ( $this->_tpl_vars['MOD']['LBL_REMINDERS_WHEN'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_REMINDERS_WHEN']; ?>
<?php endif; ?></span> -->
			<span type="text" class="reminder_when_value" /></span>
