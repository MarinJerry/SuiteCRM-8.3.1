<?php /* Smarty version 2.6.33, created on 2024-09-09 19:49:01
         compiled from modules/Configurator/tpls/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_help', 'modules/Configurator/tpls/EditView.tpl', 114, false),array('function', 'sugar_getimage', 'modules/Configurator/tpls/EditView.tpl', 421, false),)), $this); ?>
...
:</td>
		<td>
			<input type='text' size='4' id='ConfigureSettings_list_max_entries_per_page'
				   name='list_max_entries_per_page' value='<?php echo $this->_tpl_vars['config']['list_max_entries_per_page']; ?>
'>
		</td>
		<td scope="row"><?php echo $this->_tpl_vars['MOD']['LBL_SET_LISTVIEW_PAGINATION_TYPE']; ?>
:</td>
		<td><select name="listview_pagination_type"><?php echo $this->_tpl_vars['listview_pagination_type']; ?>
</select></td>
	</tr>
	<tr>
...
:</td>
		<td>
			<input type='text' size='4' id='ConfigureSettings_list_max_entries_per_subpanel'
				   name='list_max_entries_per_subpanel' value='<?php echo $this->_tpl_vars['config']['list_max_entries_per_subpanel']; ?>
'>
		</td>
		<td scope="row"><?php echo $this->_tpl_vars['MOD']['LBL_SET_SUBPANEL_PAGINATION_TYPE']; ?>
:</td>
		<td><select name="subpanel_pagination_type"><?php echo $this->_tpl_vars['subpanel_pagination_type']; ?>
</select></td>
	</tr>
	<tr>
		<td scope="row"><span><?php echo $this->_tpl_vars['MOD']['LBL_LIST_ENTRIES_PER_MODAL']; ?>
:</td>
		<td>
			<input type='text' size='4' id='ConfigureSettings_list_max_entries_per_modal' name='list_max_entries_per_modal' value='<?php echo $this->_tpl_vars['config']['list_max_entries_per_modal']; ?>
'></td>
		<td scope="row"><?php echo $this->_tpl_vars['MOD']['LBL_SET_RECORD_MODAL_PAGINATION_TYPE']; ?>
:</td>
		<td><select name="record_modal_pagination_type"><?php echo $this->_tpl_vars['record_modal_pagination_type']; ?>
</select></td>
	</tr>
	<tr>
...
>
	...
	<tr>
		<td scope="row" nowrap style="white-space: nowrap;"><?php echo $this->_tpl_vars['MOD']['MAX_DASHLETS']; ?>
: </td>
		<td>
...
' alt=$mod_strings.LBL_LOGO>
		...
		<td scope="row"><?php echo $this->_tpl_vars['MOD']['LBL_SNOOZE_TIMER']; ?>
:</td>
		<td><select name="snooze_alert_timer"><?php echo $this->_tpl_vars['SNOOZE_ALERT_TIMER']; ?>
</select></td>
    </tr>
    <tr>
        <td scope="row" width='12%' nowrap>
