<?php /* Smarty version 2.6.33, created on 2024-09-13 19:49:21
...
<button id="addFileButton" class="button primary case-addbutton" type="button"><?php if (! empty ( $this->_tpl_vars['MOD']['LBL_ADD_CASE_FILE'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_ADD_CASE_FILE']; ?>
<?php endif; ?></button>
<?php echo '
<script>
...
<script id="updateFileRowTemplate"  type="text/template">
    <span class="caseDocumentWrapper">
        <select class="caseDocumentTypeSelect">
            <option value="internal"><?php if (! empty ( $this->_tpl_vars['MOD']['LBL_SELECT_INTERNAL_CASE_DOCUMENT'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_SELECT_INTERNAL_CASE_DOCUMENT']; ?>
<?php endif; ?></option>
            <option value="external"><?php if (! empty ( $this->_tpl_vars['MOD']['LBL_SELECT_INTERNAL_CASE_DOCUMENT'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_SELECT_INTERNAL_CASE_DOCUMENT']; ?>
<?php endif; ?></option>
        </select>
        ...
        <span class="internalCaseDocumentWrapper">
            ...
            <span class="id-ff multiple selectcrossbtn">
                <button type="button" name="btn_case_document_name" id="btn_case_document_name" tabindex="0" title="<?php if (! empty ( $this->_tpl_vars['MOD']['LBL_SELECT_CASE_DOCUMENT'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_SELECT_CASE_DOCUMENT']; ?>
<?php endif; ?>" class="firstChild" value="<?php if (! empty ( $this->_tpl_vars['MOD']['LBL_SELECT_CASE_DOCUMENT'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_SELECT_CASE_DOCUMENT']; ?>
<?php endif; ?>"
                        <?php echo '
                        onclick=\'open_popup(
                                "Documents",
                ...
                <button type="button" name="btn_clr_case_document_name"
                        id="btn_clr_case_document_name" tabindex="0" title="<?php if (! empty ( $this->_tpl_vars['MOD']['LBL_CLEAR_CASE_DOCUMENT'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_CLEAR_CASE_DOCUMENT']; ?>
<?php endif; ?>"  class="lastChild"
                        onclick="SUGAR.clearRelateField(this.form, 'case_document_name', 'case_document_id');"  value="<?php if (! empty ( $this->_tpl_vars['MOD']['LBL_CLEAR_CASE_DOCUMENT'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_CLEAR_CASE_DOCUMENT']; ?>
<?php endif; ?>" >
...
<button class="removeFileButton case-removebutton" type="button"><?php if (! empty ( $this->_tpl_vars['MOD']['LBL_REMOVE_CASE_FILE'] )): ?><?php echo $this->_tpl_vars['MOD']['LBL_REMOVE_CASE_FILE']; ?>
<?php endif; ?></button><br>
</span>
</script>