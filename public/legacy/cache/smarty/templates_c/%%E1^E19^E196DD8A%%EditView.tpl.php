...
<?php endif; ?>
<input type='text' name='<?php echo $this->_tpl_vars['fields']['numero_identidad_c']['name']; ?>
'
id='<?php echo $this->_tpl_vars['fields']['numero_identidad_c']['name']; ?>
' size='30'
maxlength='255'        value='<?php echo $this->_tpl_vars['value']; ?>
' title='Agregue sin guiones. Ejemplo 0801-1990-00000'      >
</div>
...
" class="firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL'), $this);?>
"
onclick='open_popup(
...
<button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['account_name']['name']; ?>
...
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['photo_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['photo_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['photo_c']['value']; ?>
">
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['photo_c']['name']; ?>
_record_id" id="<?php echo $this->_tpl_vars['fields']['photo_c']['name']; ?>
_record_id" value="<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
">
<span id="<?php echo $this->_tpl_vars['fields']['photo_c']['name']; ?>
...
" class="tabDetailViewDFLink"><?php echo $this->_tpl_vars['fields']['photo_c']['value']; ?>
</a>
...
' onclick='SUGAR.field.file.deleteAttachment("<?php echo $this->_tpl_vars['fields']['photo_c']['name']; ?>
","",this);'>
<?php endif; ?>
</span>
<?php if (! $this->_tpl_vars['noChange']): ?>
...
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['photo_c']['name']; ?>
_escaped">
<input id="<?php echo $this->_tpl_vars['fields']['photo_c']['name']; ?>
_file" name="<?php echo $this->_tpl_vars['fields']['photo_c']['name']; ?>
_file"
...
<?php endif; ?>
<script type="text/javascript">
$( "#<?php echo $this->_tpl_vars['fields']['photo_c']['name']; ?>
...
<?php echo '\' );
addToValidate(\'EditView\', \'numero_identidad_c\', \'varchar\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NUMERO_IDENTIDAD_C','module' => 'Cases','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'photo_c\', \'image\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PHOTO','module' => 'Cases','for_js' => true), $this);?>
<?php echo '\' );
