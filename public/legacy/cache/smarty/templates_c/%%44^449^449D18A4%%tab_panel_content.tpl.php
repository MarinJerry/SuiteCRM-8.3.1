...
?>
                ...
                <?php if ($this->_foreach['colIteration']['total'] > 1 && $this->_tpl_vars['colData']['colspan'] != 3): ?>
                    <div class="col-xs-12 col-sm-6 edit-view-row-item edit-view-bordered" data-field="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
">
                <?php else: ?>
                    <div class="col-xs-12 col-sm-12 edit-view-row-item" data-field="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
">
                <?php endif; ?>
