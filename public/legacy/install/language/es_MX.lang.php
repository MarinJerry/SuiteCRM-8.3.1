...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CALL_TIME' => 'Permitir que el parámetro se pase por referencia (esto debería estar desactivado en php.ini)',
    ...
    'ERR_CHECKSYS_JSON_NOT_AVAILABLE' => "No se encontraron las funciones asociadas con las bibliotecas JSON Parser que necesita el SuiteCRM. Puede que necesites descomentar la extensión en el php.ini o recompilar el archivo correcto, dependiendo de tu versión de PHP. Para obtener ayuda consulta tu Manual de PHP.",
    'LBL_CHECKSYS_OVERRIDE_CONFIG' => 'Anulación de la configuración',
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Error de conexión a la base de datos: Verifique que sean válidos el nombre de host, puerto, usuario, y la contraseña.',
    ...
    'LBL_DBCONF_DB_PORT' => 'Puerto de base de datos',
    ...
    'LBL_APP_NOT_INSTALLED' => 'El SuiteCRM no está instalado. EntryPoint necesita un SuiteCRM activo, por favor instálelo para continuar.',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM se ha instalado correctamente.',
    'LBL_SILENT_INSTALL_FAILED' => 'Falló la instalación de SuiteCRM.',
...
$contact_user_link_guid',
    ...
    'two_factor_auth_email' => array(
        ...
        'body' => '<div><table border=\\"0\\" cellspacing=\\"0\\" cellpadding=\\"0\\" width="550" align=\\"\\&quot;\\&quot;center\\&quot;\\&quot;\\"><tbody><tr><td colspan=\\"2\\"><p>Código de Autenticación de Factor Doble es  <b>$code</b>.</p>  </td>         </tr><tr><td colspan=\\"2\\"></td>         </tr> </tbody></table> </div>',
        'txt_body' =>
            'Código de autenticación de dos factores: $code.',
    ...
    'LBL_OLD_PHP' => 'Se detecto una versión de PHP antigüa!',
    'LBL_OLD_PHP_MSG' => 'La versión de PHP recomendada para instalar SuiteCRM es %s <br />La versión mínima de PHP requerida es %s<br />Está utilizando la versión PHP %s, que es EOL: <a href="http://php.net/eol.php">http://php.net/eol.php</a>.<br />Por favor considere actualizar su versión de PHP. ',
    ...
    'LBL_DBCONFIG_MSG2' => 'Nombre del servidor web o Host en el que se encuentra la Base de Datos (por ejemplo www.mydomain.com).Si está instalando localmente, es mejor utilizar \'localhost\' en lugar de \'127.0.0.1\', por razones de rendimiento.',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Ignorar Advertencias de Comprobaciones del Sistema',
    'LBL_PROCEED' => 'PROCEDER',
    'LBL_CONFIG' => 'CONFIGURACIÓN',
    'LBL_VALIDATION_ERRORS' => 'Hay errores de validación, no se puede realizar la acción.'
);
