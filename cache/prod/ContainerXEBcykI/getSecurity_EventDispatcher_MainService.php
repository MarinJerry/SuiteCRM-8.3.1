...
class getSecurity_EventDispatcher_MainService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () use ($container) {
            return ($container->privates['App\\Security\\LegacySessionLogoutHandler'] ?? $container->load('getLegacySessionLogoutHandlerService'));
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.json_login_ldap.main'] ?? $container->load('getSecurity_Listener_JsonLoginLdap_MainService'));
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.login_throttling.main'] ?? $container->load('getSecurity_Listener_LoginThrottling_MainService'));
