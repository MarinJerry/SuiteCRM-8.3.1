...
class getServicesResetterService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () use ($container) {
            ...
            if (isset($container->privates['monolog.handler.deprecation_filter'])) {
                yield 'monolog.handler.deprecation_filter' => ($container->privates['monolog.handler.deprecation_filter'] ?? null);
            }
            if (isset($container->privates['shivas_versioning.cache.version'])) {
                yield 'shivas_versioning.cache.version' => ($container->privates['shivas_versioning.cache.version'] ?? null);
            }
        }, function () use ($container) {
            return 0 + (int) (isset($container->services['cache.app'])) + (int) (isset($container->services['cache.system'])) + (int) (isset($container->privates['cache.validator'])) + (int) (isset($container->privates['cache.serializer'])) + (int) (isset($container->privates['cache.annotations'])) + (int) (isset($container->privates['cache.property_info'])) + (int) (isset($container->privates['doctrine.result_cache_pool'])) + (int) (isset($container->privates['doctrine.system_cache_pool'])) + (int) (isset($container->privates['debug.stopwatch'])) + (int) (isset($container->services['cache.rate_limiter'])) + (int) (isset($container->services['security.token_storage'])) + (int) (isset($container->privates['cache.security_expression_language'])) + (int) (isset($container->services['doctrine'])) + (int) (isset($container->privates['api_platform.cache.route_name_resolver'])) + (int) (isset($container->privates['api_platform.cache.metadata.resource'])) + (int) (isset($container->privates['api_platform.cache.metadata.resource.legacy'])) + (int) (isset($container->privates['api_platform.cache.metadata.property.legacy'])) + (int) (isset($container->privates['api_platform.cache.subresource_operation_factory'])) + (int) (isset($container->privates['api_platform.graphql.cache.subscription'])) + (int) (isset($container->privates['api_platform.cache.identifiers_extractor'])) + (int) (isset($container->privates['monolog.handler.upgrade'])) + (int) (isset($container->privates['monolog.handler.install'])) + (int) (isset($container->privates['monolog.handler.auth'])) + (int) (isset($container->privates['monolog.handler.main'])) + (int) (isset($container->privates['monolog.handler.console'])) + (int) (isset($container->privates['monolog.handler.deprecation'])) + (int) (isset($container->privates['monolog.handler.deprecation_filter'])) + (int) (isset($container->privates['shivas_versioning.cache.version']));
        }), ['cache.app' => [0 => 'reset'], 'cache.system' => [0 => 'reset'], 'cache.validator' => [0 => 'reset'], 'cache.serializer' => [0 => 'reset'], 'cache.annotations' => [0 => 'reset'], 'cache.property_info' => [0 => 'reset'], 'doctrine.result_cache_pool' => [0 => 'reset'], 'doctrine.system_cache_pool' => [0 => 'reset'], 'debug.stopwatch' => [0 => 'reset'], 'cache.rate_limiter' => [0 => 'reset'], 'security.token_storage' => [0 => 'disableUsageTracking', 1 => 'setToken'], 'cache.security_expression_language' => [0 => 'reset'], 'doctrine' => [0 => 'reset'], 'api_platform.cache.route_name_resolver' => [0 => 'reset'], 'api_platform.cache.metadata.resource' => [0 => 'reset'], 'api_platform.cache.metadata.resource.legacy' => [0 => 'reset'], 'api_platform.cache.metadata.property.legacy' => [0 => 'reset'], 'api_platform.cache.subresource_operation_factory' => [0 => 'reset'], 'api_platform.graphql.cache.subscription' => [0 => 'reset'], 'api_platform.cache.identifiers_extractor' => [0 => 'reset'], 'monolog.handler.upgrade' => [0 => 'reset'], 'monolog.handler.install' => [0 => 'reset'], 'monolog.handler.auth' => [0 => 'reset'], 'monolog.handler.main' => [0 => 'reset'], 'monolog.handler.console' => [0 => 'reset'], 'monolog.handler.deprecation' => [0 => 'reset'], 'monolog.handler.deprecation_filter' => [0 => 'reset'], 'shivas_versioning.cache.version' => [0 => 'reset']]);
    }
}
